    ...
    <div class="client-header-left">
        ...
        <div style="min-width:0;">
            ...
            <div class="client-meta-pro">
                ...
                <?php endif; ?>
                <span class="health-indicator" title="Santé: <?= $hs ?>/3">
...
<div class="kpi-grid">
    ...
    <div class="kpi-card">
        ...
        <div class="kpi-sub" style="color:var(--g)">&#10003; À jour</div>
        <?php endif; ?>
    </div>
    <div class="kpi-card">
        <div class="kpi-label">Posts programmés</div>
...
<div class="sec" id="module-content">
    ...
    <div style="padding:40px;text-align:center;">
        ...
        <div style="font-size:16px;font-weight:600;margin-bottom:8px;color:var(--t2)">Module en cours de développement</div>
        <div style="font-size:13px;color:var(--t3)">
            <?php if (empty($locations)): ?>
                Connectez votre compte Google Business Profile pour activer les fonctionnalités.
            <?php else: ?>
