...
<div class="logo">
    <div class="logo-lockup">
        <svg class="logo-n" viewBox="0 0 60 80" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="Neura">
            <path d="M2 14L14 2L14 66L2 78Z" fill="#00E5FF"/>
            <path d="M46 14L58 2L58 66L46 78Z" fill="#00E5FF"/>
            <path d="M8 4A65 65 0 0 0 52 76" stroke="#00E5FF" stroke-width="12" stroke-linecap="butt"/>
        </svg>
...
<div class="sf">
    ...
    <a href="<?= APP_URL ?>/auth/logout.php" style="display:block;margin-top:12px;font-size:12px;color:var(--t3);text-decoration:none;">Deconnexion</a>
