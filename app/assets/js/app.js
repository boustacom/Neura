...
const APP = {
    ...
    reviewsAll: {
        ...
        async load(filter, filterLocation, page) {
            ...
            // Skeleton
            const c = document.getElementById('module-content');
            if (c && !filter) c.innerHTML = `<div class="sh"><div class="stit">Avis Google <span style="font-weight:400;color:var(--t3);font-size:13px;margin-left:6px;">Vue globale</span></div></div>${APP.skeleton.rows(6)}`;
        ...
        render(reviews, stats, locations, pagination) {
            ...
            let h = `<div class="sh" style="flex-wrap:wrap;gap:14px;">
                <div class="stit">Avis Google <span style="font-weight:400;color:var(--t3);font-size:13px;margin-left:6px;">Vue globale</span></div>
    ...
    reportsAll: {
        ...
        render() {
            ...
            h += '<div style="padding:12px 24px;border-bottom:1px solid var(--bdr);display:flex;align-items:center;gap:16px;font-size:12px;color:var(--t3);">';
    ...
    locations: {
        ...
        render() {
            ...
            let h = `<div class="sh" style="justify-content:space-between;flex-wrap:wrap;">
                <div class="stit">Toutes les fiches <span style="font-weight:400;color:var(--t3);font-size:13px;margin-left:6px;">(${locs.length})</span></div>
                <div style="display:flex;gap:8px;flex-wrap:wrap;">
...
APP.dashboard = {
    ...
    _renderKPIs(kpis, period) {
        ...
        var h = '<div class="page-section-title"><svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></svg> Indicateurs cles</div>';
    ...
    _renderMonitor(d) {
        ...
        var h = '<div class="page-section-title" style="grid-column:1/-1;margin-bottom:0;"><svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/></svg> Monitoring</div>';
