...
<style>
:root{--bg:#000;--card:#0a1628;--inp:#060e1e;--bdr:rgba(255,255,255,.1);--t1:#fff;--t2:#b8c5d6;--t3:#6b7a8f;--acc:#00d4ff;--grad:linear-gradient(135deg,#00f4ff,#1e7eff);--gh:linear-gradient(90deg,#00f4ff,#1e7eff);--gw:rgba(0,244,255,.25);--r:#EF4444;--g:#22C55E;--rd:12px;--tr:.3s ease}
